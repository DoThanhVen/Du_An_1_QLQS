...
public class FormQuanNhan extends javax.swing.JPanel {
    ...
    void OpenImage() {
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            linkImage = icon.toString();
            ImageIcon imageIcon = new ImageIcon(new ImageIcon(linkImage).getImage().getScaledInstance(120, 150, Image.SCALE_DEFAULT));
    ...
    private void initComponents() {
        ...
        cboQuanHam = new JavaClass.Combobox();
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (txtSearch.isSelected()) {
            ...
            if (option == 0) {
                ...
                loadData("Where QuanHam LIKE " + "N'" + text + "'");
            }
        }
    ...
    private void tblQuanNhanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblQuanNhanMouseClicked
        ...
        for (int i = 0; i < cboQuanHam.getItemCount(); i++) {
            if (cboQuanHam.getItemAt(i).toString().equalsIgnoreCase(tblQuanNhan.getValueAt(indexTable, 2).toString())) {
                cboQuanHam.setSelectedIndex(i);
                break;
            }
        }
